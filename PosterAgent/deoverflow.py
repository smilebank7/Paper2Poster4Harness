...
def deoverflow(args, actor_config, critic_config):
    ...
    for section_index in range(len(sections)):
        ...
        for leaf_section in subsections:
            ...
            while True:
                print(
                    f"Section: {section_name}, Leaf Section: {leaf_section}, Round: {num_rounds}"
                )
                num_rounds += 1
                ...
                curr_location, zoomed_in_img, zoomed_in_img_path = (
                ...
                jinja_args = {
                    "content_json": content[leaf_section]
                    if leaf_section in content
                ...
                critic_msg = HarnessBaseMessage.make_user_message(
                    role_name="User",
