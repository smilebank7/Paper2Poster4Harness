...
def create_theme_with_alignment(
    base_theme: Dict[str, Any], section_title_vertical_align: Optional[str] = None
) -> Dict[str, Any]:
    """
...
def resolve_colors(
    ...
    """
    final_title_text = (
        title_text_color if title_text_color is not None else DEFAULT_TITLE_TEXT_COLOR
    )
    final_title_fill = (
        title_fill_color if title_fill_color is not None else DEFAULT_TITLE_FILL_COLOR
    )
